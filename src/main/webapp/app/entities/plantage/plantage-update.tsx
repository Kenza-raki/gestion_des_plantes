...
export const PlantageUpdate = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 id="appFermeApp.plantage.home.createOrEditLabel" data-cy="PlantageCreateUpdateHeading" style={{ color: 'green' }}>
          <Translate contentKey="appFermeApp.plantage.home.createOrEditLabel">Create or edit a Plantage</Translate>
        </h2>
      </div>
      <Row
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('appFermeApp.plantage.date')} id="plantage-date" name="date" data-cy="date" type="date" />
              <ValidatedField
                label={translate('appFermeApp.plantage.nombre')}
                id="plantage-nombre"
                name="nombre"
                data-cy="nombre"
                type="text"
              ...
              <ValidatedField
                ...
                label={translate('appFermeApp.plantage.planteLibelle')}
                type="select"
              >
                <option value="" key="0" />
                {plantes
              ...
              <ValidatedField
                ...
                label={translate('appFermeApp.plantage.parcelleLibelle')}
                type="select"
              >
                <option value="" key="0" />
                {parcelles
              ...
              <Row className="justify-content-center">
                <Col md="8" style={{ display: 'flex', justifyContent: 'space-between' }}>
                  <Button tag={Link} id="cancel-save" data-cy="entityCreateCancelButton" to="/plantage" replace color="warning">
