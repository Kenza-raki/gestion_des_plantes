...
export const PlanteUpdate = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 id="appFermeApp.plante.home.createOrEditLabel" data-cy="PlanteCreateUpdateHeading" style={{ color: 'green' }}>
          <Translate contentKey="appFermeApp.plante.home.createOrEditLabel">Create or edit a Plante</Translate>
        </h2>
      </div>
      <Row
        ...
        <Col md="6">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('appFermeApp.plante.planteLibelle')}
              ...
              />
              <ValidatedField
                label={translate('appFermeApp.plante.racine')}
                id="plante-racine"
                name="racine"
                data-cy="racine"
                type="text"
              />
              <ValidatedBlobField
                label={translate('appFermeApp.plante.photo')}
                id="plante-photo"
                name="photo"
                data-cy="photo"
                openActionLabel={translate('entity.action.open')}
              />
              {/* Move the "nom" field inside this ValidatedForm */}
              <ValidatedField
                label={translate('appFermeApp.plante.nom')}
                id="plante-nom"
                name="nom"
                data-cy="nom"
                labelClassName="mt-2" // This adds margin-top to the label
                type="select"
              >
                <option value="" key="0" />
                {typePlantes
              ...
              <Row className="mt-4">
                <Col md="12" style={{ display: 'flex', justifyContent: 'space-between' }}>
                  <Button tag={Link} id="cancel-save" data-cy="entityCreateCancelButton" to="/plante" replace color="warning">
