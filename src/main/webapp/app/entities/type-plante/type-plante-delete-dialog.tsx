...
const TypePlanteDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose} style={modalStyle}>
      ...
      >
        <ModalHeader toggle={handleClose} data-cy="typePlanteDeleteDialogHeading" style={transparentStyle}>
          <Translate contentKey="entity.delete.title">Confirm delete operation</Translate>
        </ModalHeader>
        <ModalBody id="appFermeApp.typePlante.delete.question" style={transparentStyle}>
          <Translate contentKey="appFermeApp.typePlante.delete.question" interpolate={{ id: typePlanteEntity.id }}>
